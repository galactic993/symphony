...
This file is an alias of `AGENTS.md`. Keep both documents in sync when updating local operating
...
- Runtime config is loaded from `WORKFLOW.md` front matter via `SymphonyElixir.Workflow` and
